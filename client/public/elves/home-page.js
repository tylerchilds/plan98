  ...
  return `
    <div class="interlude">
      ...
      <div class="interlude-subtitle">
        A playground for personal programs paramount to protecting private projects
      </div>
      <div>
...
$.style(`
  ...
  & .interlude-cta {
    background: linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.85)), var(--root-theme, #E83FB8);
    color: white;
    font-weight: 800;
    border: none;
    padding: 1rem;
  ...
  & .logo-area {
    font-weight: 800;
    font-size: 2rem;
    background: linear-gradient(rgba(0,0,0,.5), rgba(0,0,0,.5)), linear-gradient(var(--root-theme, #E83FB8) 0%, var(--root-theme, #E83FB8) 50%, gold 50%, gold 66%, firebrick 66%, firebrick 100%);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    display: inline-block;
  }
