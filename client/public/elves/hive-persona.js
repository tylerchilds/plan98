...
const organization = 'hivelabworks.com'
...
const popoverActionsByMode = {
  error: '',
  loading: '',
  ready: `
    <action-script data-action="handleSessionStart" data-script="/public/elves/hive-persona.js">
      <div style="display: grid; white-space: nowrap; white-space: nowrap; gap: .5rem; grid-template-columns: auto 1fr; align-items: center;">
        <span>
  ...
  `,
  authenticated: `
    <action-script data-action="handleSessionEnd" data-script="/public/elves/hive-persona.js">
      <div style="display: grid; white-space: nowrap; white-space: nowrap; gap: .5rem; grid-template-columns: auto 1fr; align-items: center;">
        <span>
...
$.when('click', '.persona-actions', (event) => {
  const { mode } = event.target.dataset
  popover(event, `
    <action-script data-action="handleProfileGo" data-script="/public/elves/hive-persona.js">
    ...
    <action-script data-action="handleLogout" data-script="/public/elves/hive-persona.js">
      <div style="display: grid; gap: .5rem; grid-template-columns: auto 1fr; align-items: center;">
        <span>
...
const modes = {
  ...
  authenticated: function authenticated(target) {
    ...
    return `
      ...
      <div class="persona-context">
        Session secured as <strong>${companyEmployeeId}@${companyName}</strong> for all friend to friend friendcryption. Disengage below to end the secure session.
      </div>
      ...
      <div class="persona-context">
        Only your followers can decrypt your content scattered across the network. Manage who has access here.
      </div>
