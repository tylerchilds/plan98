...
function template(body) {
  const configObject = {
    ...
    PLAN98_APP_ID: safeEnv('PLAN98_APP_ID'),
    PLAN98_APP_SECRET: safeEnv('PLAN98_APP_SECRET'),
    PLAN98_BASE_URL: safeEnv('PLAN98_BASE_URL'),
    PLAN98_PUBLIC_KEY: safeEnv('PLAN98_PUBLIC_KEY'),
